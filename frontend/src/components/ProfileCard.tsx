        ...
        <div className="profile-card">
            ...
            <div className="profile-card__header">
                ...
                <div className="profile-card__username">
                    <span className="profile-card__username-icon">🌿</span>
                    <span>{fullName}</span>
                </div>
            </div>
                ...
                <div className="profile-card__social">
                    ...
                    {user.twitter && (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="profile-card__social-link profile-card__social-link--twitter"
                            aria-label="Twitter"
                        >
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {user.instagram && (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="profile-card__social-link profile-card__social-link--instagram"
